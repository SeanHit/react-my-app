...
import {PAGE_SIZE_ROLES} from "../../utils/constantValues"
...
export default class Role extends Component{
    ...
    updateRole = async () => {
        ...
        const role = this.state.role // 得到最新的 menus
        ...
        return(
            <Card title={title}>
                <Table
                    ...
                    pagination={{defaultPageSize: PAGE_SIZE_ROLES}}
                    rowSelection={{type: 'radio', selectedRowKeys: [role._id]}}
                    onRow={this.onRow}    //用来检测row有关的回调函数
                />
                <Modal
                    title="添加角色"
                    visible={isShowAdd}
